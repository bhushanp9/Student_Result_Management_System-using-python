...
class resultClass:
  ...
  #=========title=================== 
        ...
        lbl__full_marks=Label(self.root,text="Full Marks",font=("goudy old style",20,'bold'),bg='white').place(x=50,y=340)  
 ...
 #=====================Images==============================
        ...
        original_image = Image.open("exam_result.jpg")
        resized_image = original_image.resize((400, 330))  # Set width and height you want
        self.bg_img = ImageTk.PhotoImage(resized_image)

           # Set image to Label
        self.lbl_bg = Label(self.root, image=self.bg_img)
        self.lbl_bg.place(x=750, y=100)
    ...
    def add(self):
      ...
      try:
         if self.var_name.get()=="":
          ...
          row=cur.fetchone()
          if row!=None:
            messagebox.showerror("Error","Result already present required",parent=self.root)
          else:
