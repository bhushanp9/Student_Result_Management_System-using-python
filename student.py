    ...
    def add(self):
      ...
      try:
         if self.var_roll.get()=="":
          ...
          row=cur.fetchone()
          if row!=None:
            messagebox.showerror("Error","Roll number already present required",parent=self.root)
          else:
            ...
            con.commit()
            messagebox.showinfo("Success","Student detailed Added Successfully",parent=self.root)
            self.show()
      except Exception as ex:
            messagebox.showerror("Error",f"Error due to{str(ex)}")  
      ...
      try:
         if self.var_roll.get()=="":
          ...
          if row==None:
            ...
            con.commit()
            messagebox.showinfo("Success","Student detailed Updated Successfully",parent=self.root)
            self.show()
      except Exception as ex:
            messagebox.showerror("Error",f"Error due to{str(ex)}") 
